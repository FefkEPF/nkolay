...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className={`max-w-7xl mx-auto flex items-center justify-between relative transition-all duration-500 bg-white/70 backdrop-blur-2xl border border-white/50 rounded-full px-6 ${
